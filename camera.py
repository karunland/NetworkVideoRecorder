...
HQoutput = FfmpegOutput("-f rtsp -rtsp_transport udp rtsp://username:password@127.0.0.1:8554/hqstream", audio=False)
LQoutput = FfmpegOutput("-f rtsp -rtsp_transport udp rtsp://username:password@127.0.0.1:8554/lqstream", audio=False)
